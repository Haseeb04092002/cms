...
class Attendance extends MY_Controller
{
	...
	public function index()
	{
		...
		switch ($UserRole) {
			case 'Admin':
				...
				$this->output->set_header('X-Page-Title: Select Class For Attendance');
	...
	public function save_attendance()
	{
		...
		$this->output->set_header('X-Page-Title: Save Attendance');
	...
	public function mark_attendance($classId = '', $className = '', $sectionName = '')
	{
		...
		$this->output->set_header('X-Page-Title: Mark Attendance');
