...
class Fee extends MY_Controller
{
    public function add_fee_structure()
    {
        ...
        $this->output->set_header('X-Page-Title: Add Fee Structure');
        exit(json_encode($Response));
    }
    ...
    public function delete_fee_structure()
    {
        ...
        $this->output->set_header('X-Page-Title: Delete Fee Structure');
        exit(json_encode($Response));
    }
    ...
    public function collect_fee()
    {
        ...
        $this->output->set_header('X-Page-Title: Collect Fee');
        exit(json_encode($Response));
    }
    ...
    public function my_fees()
    {
        ...
        $this->output->set_header('X-Page-Title: Fee Details');
    ...
    public function fees_structure()
    {
        ...
        $this->output->set_header('X-Page-Title: Fee Structure');
        $this->load->view('pages/finance/fees_structure', $data);
    }



    public function fees_collection($studentId = '')
    {
        $UserId = '';
        $UserName = '';
        $UserEmail = '';
