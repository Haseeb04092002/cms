...
<div class="container-fluid p-4">
    ...
    <div class="mb-3 justify-content-between align-items-center d-flex">
        ...
        <div class="align-items-center d-flex">
            <a href="<?= site_url('Tasks/student_task_pdf/' . $task->taskId) ?>"
                target="_blank"
            ...
            <?php if ($this->session->userdata('user_role') != 'Student'): ?>
                <div class="<?= ($readOnly ? 'd-block' : 'd-none') ?>">
                    <button class="btn btn-sm btn-warning" id="editTaskBtn">Edit Task</button>
                </div>
            <?php endif; ?>
        </div>
    </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <textarea class="form-control"
                            ...
                            <?= ($readOnly ? 'readonly' : '') ?>
                            placeholder="Write task details, instructions, references..."><?= $task->taskDescription ?? '' ?></textarea>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('submit', '.FormSaveTask', function(e) {
            ...
            $.ajax({
                url: "<?= site_url('Tasks/individual_save_task/edit') ?>",
                type: "POST",
                data: formData,
                dataType: "json",
                cache: false,
