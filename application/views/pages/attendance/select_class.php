<div class="p-4">
    <h3 class="fw-bold mb-4">Select class to mark attendance</span></h3>
    ...
    <div class="row g-4">
        <?php foreach ($classes as $class): 
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <a style="cursor: pointer;" href="<?= site_url('Attendance/mark_attendance/') . $class->classId . '/' . $class->className . '/' . $class->sectionName ?>" class="navigator text-decoration-none">
