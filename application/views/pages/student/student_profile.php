                ...
                <div class="card profile-card shadow-sm h-100 border-0">
                    <div class="card-body text-center">
                        ...
                        <div class="<?= ($UserRole === "Student") ? 'd-none' : 'd-block' ?> profile-actions d-grid gap-2 mt-4">
                            ...
                            <a href="<?= site_url('Tasks/all_tasks/') . $student->studentId ?>" class="navigator btn btn-primary">
                                <i class="bi bi-pencil-square me-2"></i> Tasks
                            </a>
                            <a href="<?= site_url('Fee/fees_collection/') . $student->studentId ?>" class="navigator btn btn-primary">
