...
================================ */
    ...
    @media (max-width: 576px) {
        ...
        /* Stack sibling fields vertically */
    ...
    <div class="card">
        <div class="container">
            <form id="AdmissionForm"
                ...
                <h3 class="d-none p-2 text-center">
                    <?php
                ...
                <div class="card mb-4 border-0">
                    ...
                    <div class="card-body row g-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold">Admission Number <span class="fs-5 text-danger">*</span></label>
                            <input type="text" name="admission_no" class="form-control" value="<?= $student->admissionNo ?? '' ?>" required>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-bold">Education Type <span class="fs-5 text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold">Class <span class="fs-5 text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-bold">Batch Year <span class="fs-5 text-danger">*</span></label>
                ...
                <div class="card mb-4 border-0">
                    ...
                    <div class="card-body row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold">First Name <span class="fs-5 text-danger">*</span></label>
                            <input type="text" name="student_first_name" class="form-control" value="<?= $student->firstName ?? '' ?>" required>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label fw-bold">Last Name</label>
                            <input type="text" name="student_last_name" class="form-control" value="<?= $student->lastName ?? '' ?>">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-bold">Date of Birth <span class="fs-5 text-danger">*</span></label>
                            <input type="date" name="dob" class="form-control" value="<?= $student->dateOfBirth ?? '' ?>" required>
                        </div>

                        <div class="col-md-3">
                            <label class="form-label fw-bold">Gender <span class="fs-5 text-danger">*</span></label>
                        ...
                        <!-- OTHER CHILDREN -->
                        <div class="col-md-12">
                            <label class="form-label fw-bold fw-semibold">Other Siblings Studying</label>
                ...
                <!-- STUDENT INFO -->
                <div class="card mb-4 border-0">
                    <div class="card-header bg-light fw-bold">PARENTS INFORMATION</div>
                    <div class="card-body row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-bold">Contact 1 <span class="fs-5 text-danger">*</span></label>
                            <input type="text"
                                name="contact_1"
                                class="form-control"
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text"
                                name="contact_2"
                                class="form-control"
                                value="<?= $student->contactNo2 ?? '' ?>">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-bold">Contact 3</label>
                            <input type="text"
                                name="contact_3"
                                class="form-control"
                                value="<?= $student->contactNo3 ?? '' ?>">
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-bold">Address <span class="fs-5 text-danger">*</span></label>
                            <input type="text"
                                name="address"
                                class="form-control"
