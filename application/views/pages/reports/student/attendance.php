...
<div class="p-4">
  ...
  <div class="card mb-5">
    <div class="card-body">
      <form id="frmReport" class="searchFilterForm" action="<?= site_url('Reports/ajax_generate_student_report/attendance') ?>">
        <div class="row g-3 mb-3">

          <div class="<?= ($UserRole === "Student") ? 'd-none' : 'd-block' ?> col-md-2">
          ...
          <input type="hidden" name="className" value="<?= $classes->classId ?? '' ?>">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $(document).off('submit', '.searchFilterForm').on('submit', '.searchFilterForm', function(e) {
      ...
      $('#attendanceRows').html('<tr><td colspan="4">Loading...</td></tr>');
