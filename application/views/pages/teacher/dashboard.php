<?php
$assignedLectures = count($subject_class_assigns) ?? 0;
                ...
                <div class="container-fluid py-3">
                    ...
                    <div class="card shadow-sm border-0 mt-4">
                        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= site_url('Cms/assign_classes_subjects/') . $teacher->staffId ?? '' ?>" class="<?= ($this->session->userdata('user_role') === 'Admin') ? 'd-block' : 'd-none'; ?> navigator btn btn-sm btn-primary">Assign Classes and Subjects</a>
                        </div>
