...
<nav class="d-none d-lg-block sidebar">
    <div class="menu_content">
        ...
        <ul class="menu_items">
            ...
            <li class="<?= ($UserRole == 'Admin') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('OnlineClass') ?>" class="nav_link navigator side-menu-links">
                    <span class="navlink_icon"><i class="bi bi-camera-video"></i></span>
                    <span class="navlink">All Online Classes</span>
                </a>
            </li>

            <li class="<?= ($UserRole == 'Admin') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('OnlineClass/create') ?>" class="nav_link navigator side-menu-links">
                    <span class="navlink_icon"><i class="bi bi-plus-circle"></i></span>
                    <span class="navlink">Create Online Class</span>
                </a>
            </li>
            ...
            <li class="<?= ($UserRole == 'Teacher') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('OnlineClass/teacher') ?>" class="nav_link navigator side-menu-links">
                    <span class="navlink_icon"><i class="bi bi-easel"></i></span>
                    <span class="navlink">My Classes</span>
                </a>
            </li>
            ...
            <li class="<?= ($UserRole == 'Teacher') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('OnlineClass/create') ?>" class="nav_link navigator side-menu-links">
                    <span class="navlink_icon"><i class="bi bi-plus-circle"></i></span>
                    <span class="navlink">Create Class</span>
                </a>
            </li>
            ...
            <li class="<?= ($UserRole == 'Admin') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('Fee') ?>" class="nav_link navigator side-menu-links">
            ...
            <li class="<?= ($UserRole == 'Admin') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('Reports') ?>" class="nav_link navigator side-menu-links">
            ...
            <!-- My Timetable -->
            <li class="<?= ($UserRole == 'Teacher') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('Teacher/teacher_time_table') ?>" class="nav_link navigator side-menu-links">
            ...
            <li class="<?= ($UserRole == 'Student') ? 'd-block' : 'd-none' ?> item">
                <a href="<?= site_url('OnlineClass/student') ?>" class="nav_link navigator side-menu-links">
                    <span class="navlink_icon"><i class="bi bi-mortarboard"></i></span>
                    <span class="navlink">My Online Classes</span>
                </a>
            </li>
...
<div class="offcanvas offcanvas-start d-lg-none w-75" tabindex="-1" id="mainSidebar">
    ...
    <div class="offcanvas-body p-0">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="<?= site_url('OnlineClass') ?>"
                class="list-group-item list-group-item-action navigator <?= ($UserRole == 'Admin') ? '' : 'd-none' ?>">
                <i class="bi bi-camera-video me-2"></i> All Online Classes
            </a>

            <a href="<?= site_url('OnlineClass/create') ?>"
                class="list-group-item list-group-item-action navigator <?= ($UserRole == 'Admin') ? '' : 'd-none' ?>">
                <i class="bi bi-plus-circle me-2"></i> Create Online Class
            </a>
            ...
            <a href="<?= site_url('OnlineClass/student') ?>"
                class="list-group-item list-group-item-action navigator <?= ($UserRole == 'Student') ? '' : 'd-none' ?>">
                <i class="bi bi-mortarboard me-2"></i> My Online Classes
            </a>

            <a href="<?= site_url('Student/admission_requests') ?>"
                class="list-group-item list-group-item-action navigator <?= ($UserRole == 'Admin') ? '' : 'd-none' ?>">
...
<script>
    ...
    // $(document).on("click", "#mainSidebar .navigator", function() {
